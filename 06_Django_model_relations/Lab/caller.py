...
lecturer2 = Lecturer.objects.get(first_name="Jane", last_name="Smith")
Subject.objects.get(name="Mathematics", code="MATH101", lecturer=lecturer1)
Subject.objects.get(name="History", code="HIST101", lecturer=lecturer2)
Subject.objects.get(name="Physics", code="PHYS101", lecturer=lecturer1)
...
test_1 = Lecturer.objects.filter(first_name='John', last_name='Doe')
test_2 = Lecturer.objects.get(first_name='John', last_name='Doe')

print(f"FILTER: {test_1}")  # Returns QuerySet
print(f"GET: {test_2}")     # Returns Object

# ------------- 2. The Student -------------
# Keep the data from the previous exercise, so you can reuse it

student1 = Student.objects.get(student_id="M1051", first_name="Alice", last_name="Johnson", birth_date="2000-01-15", email="a.johnson@abv.bg")
student2 = Student.objects.get(student_id="S217", first_name="Bob", last_name="Smith", birth_date="2001-05-20", email="bobby@gmail.com")
...
print(Subject.objects.get(name='Physics').student_set.all())    # QuerySet of all students that study Physics
